...
class _PrivacyDetailsScreenState extends State<PrivacyDetailsScreen> {
  final List<Map<String, dynamic>> _privacyItems = [
    ...
    },
    {
      ...
      'title': 'Удаление аккаунта и ваших данных',
      'description':
          'Вы имеете полное право удалить свой аккаунт в любое время. '
          'Для этого перейдите в раздел "Профиль" → "Удалить аккаунт". '
          'При удалении аккаунта будут безвозвратно удалены:\n\n'
          '• Ваши личные данные (имя, email, телефон)\n'
          '• История всех заказов\n'
          '• Список избранных товаров\n'
          '• Сохранённые адреса доставки\n'
          '• Промокоды и бонусы\n'
          '• Данные аналитики, связанные с вами\n\n'
          '⚠️ ВНИМАНИЕ: Восстановить аккаунт после удаления невозможно. '
          'Данные из Яндекс.Метрики будут обезличены в течение 30 дней. '
          'Пожалуйста, завершите все активные заказы перед удалением аккаунта.',
    },
    {
      'icon': Icons.email,
      'iconColor': Colors.red,
